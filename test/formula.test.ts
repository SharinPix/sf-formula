...
describe('formula_eval', () => {
  ...
  */
  ...
  describe('COUNTMATCHES', () => {
    ...
    testFormulaError('COUNTMATCHES(2, 2)', {}, 'Argument 1 of COUNTMATCHES must be a string or an array', 'COUNTMATCHES with first argument not string or array');
    testFormulaError('COUNTMATCHES(true, "value")', {}, 'Argument 1 of COUNTMATCHES must be a string or an array', 'COUNTMATCHES with boolean first argument');
    testFormulaError('COUNTMATCHES(null, "value")', {}, 'Argument 1 of COUNTMATCHES must be a string or an array', 'COUNTMATCHES with null first argument');

  ...
  */
  ...
  describe('DATEVALUE', () => {
    testFormulaStrictEqual(
      ...
      {},
      new Date('2024-01-01'),
      'DATEVALUE converts date string to date'
    );
  ...
  describe('ADDDAYS', () => {
    testFormulaStrictEqual(
      ...
      new Date('2024-01-02'),
      'ADDDAYS adds days to date string'
    );
    testFormulaStrictEqual(
      'ADDDAYS(date, 50)',
      { date: new Date('2024-01-01') },
    ...
    testFormulaError(
      'ADDDAYS(date, "1")',
      { date: new Date('2024-01-01') },
      'Argument 2 of ADDDAYS must be a positive integer',
      'ADDDAYS with string argument'
    );
    testFormulaError(
      'ADDDAYS(date, 1.5)',
      { date: new Date('2024-01-01') },
      'Argument 2 of ADDDAYS must be a positive integer',
      'ADDDAYS with number argument'
    );
    testFormulaError(
      'ADDDAYS(date, true)',
      { date: new Date('2024-01-01') },
      'Argument 2 of ADDDAYS must be a positive integer',
      'ADDDAYS with boolean argument'
    );
    testFormulaError(
      'ADDDAYS(date, null)',
      { date: new Date('2024-01-01') },
      'Argument 2 of ADDDAYS must be a positive integer',
      'ADDDAYS with null argument'
    );
    testFormulaError(
      'ADDDAYS(date, undefined)',
      { date: new Date('2024-01-01') },
      'Argument 2 of ADDDAYS must be a positive integer',
      'ADDDAYS with undefined argument'
    );
    testFormulaError(
      'ADDDAYS("123", 1)',
      {},
      'Argument 1 of ADDDAYS must be a date',
      'ADDDAYS with string argument'
    );
    testFormulaError(
      'ADDDAYS(123, 1)',
  ...
  describe('DAYSBETWEEN', () => {
    testFormula(
      ...
      { date1: new Date('2024-01-01'), date2: new Date('2024-01-01') },
      0,
      'DAYSBETWEEN between two dates'
    );
    testFormula(
      'DAYSBETWEEN(date1, date2)',
      { date1: new Date('2024-01-01'), date2: new Date('2024-01-03') },
      -2,
      'DAYSBETWEEN between two dates'
    );
    testFormula(
      'DAYSBETWEEN(date1, date2)',
      { date1: new Date('2024-01-03'), date2: new Date('2024-01-01') },
      2,
      'DAYSBETWEEN between two dates'
    );
    testFormula(
      'DAYSBETWEEN(date1, date2)',
      { date1: new Date('2024-01-01'), date2: new Date('2024-02-03') },
      -33,
      'DAYSBETWEEN between two dates'
    );
    testFormula(
      'DAYSBETWEEN(date1, date2)',
      { date1: new Date('2025-01-29'), date2: new Date('2024-03-01') },
      334,
      'DAYSBETWEEN between two dates'
    );
    ...
    testFormulaError(
      'DAYSBETWEEN("1", date)',
      { date: new Date('2024-01-01') },
      'Argument 1 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with string argument'
    );
    testFormulaError(
      'DAYSBETWEEN(1.5, date)',
      { date: new Date('2024-01-01') },
      'Argument 1 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with number argument'
    );
    testFormulaError(
      'DAYSBETWEEN(true, date)',
      { date: new Date('2024-01-01') },
      'Argument 1 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with boolean argument'
    );
    testFormulaError(
      'DAYSBETWEEN(null, date)',
      { date: new Date('2024-01-01') },
      'Argument 1 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with null argument'
    );
    testFormulaError(
      'DAYSBETWEEN(undefined, date)',
      { date: new Date('2024-01-01') },
      'Argument 1 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with undefined argument'
    );
    testFormulaError(
      'DAYSBETWEEN(date, "1")',
      { date: new Date('2024-01-01') },
      'Argument 2 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with string argument'
    );
    testFormulaError(
      'DAYSBETWEEN(date, 1.5)',
      { date: new Date('2024-01-01') },
      'Argument 2 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with number argument'
    );
    testFormulaError(
      'DAYSBETWEEN(date, true)',
      { date: new Date('2024-01-01') },
      'Argument 2 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with boolean argument'
    );
    testFormulaError(
      'DAYSBETWEEN(date, null)',
      { date: new Date('2024-01-01') },
      'Argument 2 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with null argument'
    );
    testFormulaError(
      'DAYSBETWEEN(date, undefined)',
      { date: new Date('2024-01-01') },
      'Argument 2 of DAYSBETWEEN must be a date',
      'DAYSBETWEEN with undefined argument'
    );
